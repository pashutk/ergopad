...
import { i as internal, F as Functor, C as Chain, A as Applicative, S as Separated } from './Separated-8613e55b.js';
...
var getValidationSemigroup = function (SE, SA) {
    return Apply.getApplySemigroup(getApplicativeValidation(SE))(SA);
};
...
var getValidationMonoid = function (SE, MA) {
    return Applicative.getApplicativeMonoid(getApplicativeValidation(SE))(MA);
};
